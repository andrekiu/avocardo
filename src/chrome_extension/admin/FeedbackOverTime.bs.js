...
var FeedbackOverTime_graphql$Avocardo = require("../../__generated__/FeedbackOverTime_graphql.bs.js");

var styles = ChartsModuleCss;

function use(fRef) {
  var data = Hooks.useFragment(FeedbackOverTime_graphql$Avocardo.node, fRef);
  return RescriptRelay_Internal.internal_useConvertedValue(FeedbackOverTime_graphql$Avocardo.Internal.convertFragment, data);
}

function useOpt(opt_fRef) {
  var fr = opt_fRef !== undefined ? Caml_option.some(Caml_option.valFromOption(opt_fRef)) : undefined;
  var nullableFragmentData = Hooks.useFragment(FeedbackOverTime_graphql$Avocardo.node, fr !== undefined ? Js_null_undefined.fromOption(Caml_option.some(Caml_option.valFromOption(fr))) : null);
  var data = (nullableFragmentData == null) ? undefined : Caml_option.some(nullableFragmentData);
  return RescriptRelay_Internal.internal_useConvertedValue((function (rawFragment) {
                if (rawFragment !== undefined) {
                  return FeedbackOverTime_graphql$Avocardo.Internal.convertFragment(rawFragment);
                }
                
              }), data);
}

var FeedbackOverTimeFragment = {
  Types: undefined,
  use: use,
  useOpt: useOpt
};

function FeedbackOverTime(Props) {
...
var make = FeedbackOverTime;

exports.styles = styles;
exports.FeedbackOverTimeFragment = FeedbackOverTimeFragment;
exports.make = make;
