...
function Dashboard$AnswersOverTime(Props) {
  ...
  var data = $$Array.map((function (row) {
        ...
        }), match.getAdminProfile.answersOverTime);
...
var AnswersOverTime = {
  make: Dashboard$AnswersOverTime
};
  ...
  return React.createElement("div", {
              className: styles.root
                  ...
                  children: React.createElement(React.Suspense, {
                        children: React.createElement(Dashboard$AnswersOverTime, {}),
                        fallback: null
                      }),
...
exports.Query = Query;
exports.AnswersOverTime = AnswersOverTime;
exports.Card = Card;
exports.make = make;
